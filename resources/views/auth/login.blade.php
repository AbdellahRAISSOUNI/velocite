<x-guest-layout>
    ...
    <div class="flex mb-6 border-b border-gray-200">
        ...
        <button type="button" class="px-4 py-2 font-medium text-sm text-gray-500 hover:text-gray-700" id="agent-tab">
            Agent
        </button>
    ...
    <div class="mb-6 p-4 bg-blue-50 rounded-md border border-blue-100">
        <div id="role-description" class="text-sm text-blue-800">
            ...
            <p id="agent-description" class="hidden flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                Agent accounts can provide customer support, moderate listings, and manage disputes.
            </p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const tabs = ['client', 'partner', 'agent', 'admin'];
